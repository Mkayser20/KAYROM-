...
<div class="auth-card">
    ...
    <form method="POST" action="index.php?page=iniciar_sesion&action=iniciar_sesion" class="auth-form">
        ...
        <a href="index.php?page=recuperar_clave" class="forgot-link">Olvidé mi contraseña</a>
