...
CREATE TABLE `empleado` (
  `id` int NOT NULL AUTO_INCREMENT,
  `rango_trabajo` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `especialidad` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `modelo_vehiculo` (
  `id` int NOT NULL AUTO_INCREMENT,
  `modelo_vehiculo` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `modelo_vehiculo` VALUES (1,'Toyota Hilux',2021),(2,'Ford Ranger',2022),(3,'Volkswagen Amarok',2020),(4,'Renault Kangoo',2019),(5,'Toyota Hilux srv',2023),(6,'Chevrolet S10',2021),(7,'Fiat Ducato',2020),(8,'Toyota Corolla',2022);
...
INSERT INTO `orden_trabajo` VALUES (1,11,17,'2026-09-06 16:07:10','cambio de aceite','Abierta'),(2,7,12,'2026-09-06 16:08:01','cambio de frenos ','Abierta');
/*!40000 ALTER TABLE `orden_trabajo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `orden_trabajo_repuesto`
--

DROP TABLE IF EXISTS `orden_trabajo_repuesto`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `orden_trabajo_repuesto` (
  ...
  `cantidad` int NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `fk_otr_orden` (`orden_trabajo_id`),
...
--
-- Dumping data for table `orden_trabajo_repuesto`
--

LOCK TABLES `orden_trabajo_repuesto` WRITE;
/*!40000 ALTER TABLE `orden_trabajo_repuesto` DISABLE KEYS */;
INSERT INTO `orden_trabajo_repuesto` VALUES (1,1,5,2),(2,2,4,1);
...
CREATE TABLE `pedidos` (
  ...
  `estado_pedido` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `responsable_pedido` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `pedidos` VALUES (2,'2024-04-03 11:30:00','Aprobado','Kayser',1002,20,2,NULL),(3,'2024-04-05 14:00:00','Entregado','Medina',1003,30,3,NULL),(4,'2024-04-08 08:45:00','Pendiente','Romero',1004,4,4,NULL),(8,'2026-06-09 14:40:07','En proceso','Gonzalo Gauna',4426,1,7,NULL),(9,'2026-09-06 15:46:35','Pendiente','Migue',3614,2,8,NULL),(10,'2026-09-06 15:46:35','Pendiente','Migue',5017,3,9,6),(11,'2026-09-06 15:47:47','Pendiente','Migue',3080,5,10,1),(12,'2026-09-06 15:47:47','Pendiente','Migue',1946,1,11,4);
...
CREATE TABLE `persona` (
  ...
  `domicilio` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `proveedor` (
  ...
  `nombre_proveedor` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `proveedor` VALUES (1,30712345678,'AutoPartes Norte SRL',3704421000,'ventas@autopartesnorte.com',7),(2,30798765432,'Repuestos Del Chaco',3704422000,'pedidos@repuestoschaco.com',8),(4,999999999,'Ramon Diaz',370499999,'rmon@gmail.com',NULL),(5,80000000000000,'Mauro Lombardo',37048755589,'miguelangelromero@xdgmail.com',NULL),(6,2055555565539,'lubricantes xs',3711555555,'lubricanteslosjerores@gmail.com',NULL);
...
INSERT INTO `repuestos` VALUES (2,'Frenos','Frenos',1,5,1500.00,'',1),(3,'Suspensión  Hilux','Suspensión',2,5,150000.00,NULL,NULL),(4,'Frenos blablabla','Frenos',14,5,9999.00,'',4),(5,'Aceite Xd','Lubricantes',17,5,25000.00,'',6);
...
CREATE TABLE `tipo_vehiculo` (
  `id` int NOT NULL AUTO_INCREMENT,
  `tipo_vehiculo` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `tipo_vehiculo` VALUES (1,'Automóvil'),(2,'Camioneta'),(3,'Camión'),(5,'Utilitario');
...
CREATE TABLE `usuario` (
  ...
  `token_recuperacion` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `token_expiracion` datetime DEFAULT NULL,
  `rol` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'empleado',
  PRIMARY KEY (`id`),
  KEY `persona_id` (`persona_id`),
...
CREATE TABLE `vehiculo` (
  ...
  `patente` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numero_chasis` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numero_motor` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `vehiculo` VALUES (2,1,'EF 456 GH','CH556677889900','MT112233','2024-01-22 00:00:00',0,2,2,'En Diagnóstico',0,NULL),(3,1,'IJ 789 KL','CH223344556677','MT445566','2023-11-05 00:00:00',0,2,3,'En Diagnóstico',0,NULL),(4,1,'MN 012 OP','CH334455667788','MT778899','2024-02-14 00:00:00',0,5,4,'En Diagnóstico',0,NULL),(7,1,'YZ 901 AB','CH667788990022','MT667788','2024-04-10 00:00:00',0,1,8,'En Reparación',0,NULL),(10,1,'AA22BC','123EE2','243321','2026-05-22 00:00:00',0,1,5,'En Diagnóstico',0,NULL),(11,1,'YZ 901 A2','99999999999999991','243321','2026-05-23 00:00:00',0,1,7,'En Reparación',0,NULL);
...
-- Dump completed on 2026-09-07  8:30:32
